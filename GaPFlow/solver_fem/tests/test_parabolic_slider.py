...
with the solver_fem solver and plots the steady-state density and mass flux.

Config: configs/parabolic_slider.yaml

Usage:
    /home/qd5728/fem_taylor_hood/venv/bin/python \
        GaPFlow/solver_fem/tests/test_parabolic_slider.py
"""
...
if __name__ == '__main__':
    ...
    plt.suptitle(f'Parabolic Slider (solver_fem): Nx={Nx}, Ny={Ny}')
