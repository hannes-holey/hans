...
# Region boundaries [m]
x_s1_start = 0.000          # slider 1 starts at domain inlet
x_s1_end   = x_s1_start + 0.036   # 0.036

x_flat_sep_start = x_s1_end           # 0.036
...
out_file = os.path.join(out_dir, 'twin_parabolic_slider.npy')
...
# Fill below profile (fluid gap)
ax.fill_between(x_plot, 0, h_plot, color='steelblue', alpha=0.35)
# Fill above profile (solid upper wall)
...
fig.tight_layout()
plot_file = os.path.join(out_dir, 'twin_parabolic_slider.png')
