...
ax[0].set_ylabel(r'$C_{j\parallel}$')
ax[0].plot(C[:,0] * 1e12, C[:,1])
ax[0].plot(C[:,0] * 1e12, C[:,3])
ax[1].set_ylabel(r'$C_{j\perp}$')
ax[1].plot(C[:,0] * 1e12, C[:,2])
ax[1].plot(C[:,0] * 1e12, C[:,4])
ax[2].set_ylabel(r'$C_\rho$')
...
ax[1].plot(C[:,0] * 1e12, C_trans_ana, '--', color='0.7')
ax[2].plot(C[:,0] * 1e12, C_long_ana, '--', color='0.7')
