...
The [µGrid](https://muspectre.github.io/muGrid/) [@mugrid_0_105_2] library is used to assemble the discretized density and flux fields into a unified container and to export the simulation results in the NetCDF file format [@rew1990_netcdf].
...
For simulations in this *Elastohydrodynamic Regime*, `GaPFlow` uses the [ContactMechanics](https://contactengineering.github.io/ContactMechanics/) [@contactmechanics_1_8_1] code which is part of the [contact.engineering](https://contact.engineering) [@rottger2022_contactengineeringcreate] ecosystem to compute elastic deformations of the walls in contact with the fluid.
